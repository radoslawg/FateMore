...
function update()
	...
	if updateControl("aspects", bReadOnly, bID) then bSection2 = true; end
	if updateControl("stunts", bReadOnly, bID) then bSection2 = true; end

    ammostress.setReadOnly(bReadOnly);
